...
<div class="content-wrapper" style="min-height: 1461px;overflow: auto;">
    ...
    <section class="content-header">
        <h1>
            <center>Number of Student complained in Department</center>
        ...
        <table class="table table-user-information">
            <tbody style="border: 1px solid #222d32">
                <tr>
                    ...
                    <td style="border: 1px solid #222d32"><b>Number of Student claimed</b></td>
                </tr>
                <?php
                $sql = "select * from numstdcompindept";
//                echo $sql;
                $result = showData($sql);
//                print_r($result);
                foreach ($result as $row) {
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #222d32"><?php echo $row["numstd"]; ?></td>
                    </tr><?php } ?>
            </tbody></table>
    </div>
    <!-- /.content -->
